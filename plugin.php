...
require_once __DIR__ . '/inc/plugin-filter/namespace.php';
require_once __DIR__ . '/inc/plugin-filter/class-api-client.php';
require_once __DIR__ . '/inc/plugin-filter/settings.php';
