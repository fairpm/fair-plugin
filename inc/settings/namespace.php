...
function render_settings_page() {
	...
	<div class="wrap fair-settings">
		...
		<p><?php printf(
			...
			esc_html__( 'Your site is now disconnected from WordPress.org managed servers and uses a dedicated mirror from %1$sAspirePress%2$s. In the coming weeks and months, we\'ll be making the mirror configurable and add in the ability to add your own.', 'fair' ),
			'<a href="https://aspirepress.org/" target="_blank">', '</a>'
		); ?></p>
		<p><?php printf(
			/* translators: %1$s: FAIR GitHub URL, %2$s: FAQ URL */
			esc_html__( 'If you want to learn more, check out the %1$sFAIR GitHub%2$s and our %3$sFAQ%2$s.', 'fair' ),
			'<a href="https://fair.pm/" target="_blank">', '</a>', '<a href="https://github.com/fairpm/tsc/blob/main/faqs/README.md" target="_blank">'
		); ?></p>
		<form method="post">
